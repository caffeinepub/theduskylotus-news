...
export interface _SERVICE {
  ...
  'createArticle' : ActorMethod<[Article], ArticleId>,
  'deleteArticle' : ActorMethod<[ArticleId], undefined>,
  'getAllArticleSlugs' : ActorMethod<[], Array<string>>,
  ...
  'getHomepageArticles' : ActorMethod<[], Array<Article>>,
  'getPublishedArticles' : ActorMethod<[], Array<Article>>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'searchArticles' : ActorMethod<[string], Array<Article>>,
  'togglePublished' : ActorMethod<[ArticleId], undefined>,
  'updateArticle' : ActorMethod<[ArticleId, Article], undefined>,
}
