...
import type { Article as _Article, ArticleId as _ArticleId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createArticle(arg0: Article): Promise<ArticleId> {
        if (this.processError) {
            try {
    ...
    async getAllArticleSlugs(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllArticleSlugs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHomepageArticles(): Promise<Array<Article>> {
        if (this.processError) {
            try {
    ...
    async togglePublished(arg0: ArticleId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateArticle(arg0: ArticleId, arg1: Article): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_Article_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Article): Article {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Article]): Article | null {
    return value.length === 0 ? null : from_candid_Article_n13(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        coverImageId: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.coverImageId)),
        published: value.published,
        createdAt: value.createdAt,
        slug: value.slug,
        audioFileId: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.audioFileId)),
...
function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Article>): Array<Article> {
    return value.map((x)=>from_candid_Article_n13(_uploadFile, _downloadFile, x));
}
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        createdAt: value.createdAt,
        slug: value.slug,
        audioFileId: value.audioFileId ? candid_some(value.audioFileId) : candid_none(),
        excerpt: value.excerpt,
        category: value.category,
        bodyHtml: value.bodyHtml
    };
